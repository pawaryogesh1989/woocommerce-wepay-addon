...
1. Download and upload the plugin files to the `/wp-content/plugins/woocommerce-wepay-addon` directory from the Wordpress plugin repository.
2. Activate the plugin through the 'Plugins' screen in WordPress admin.

= Using Plugin Interface =

1. Open the plugin Interface in the wordpress admin and click on "Add new".
2. In the Search box enter "WePay Woocommerce addon" and hit Enter.
